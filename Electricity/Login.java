...
public class Login extends JFrame implements ActionListener{
    JLabel l1,l2,l3, l4;
    JTextField tf1;
    JPasswordField pf2; //a text component specialized for password entry
    JButton b1,b2, b3;
    JPanel p1,p2,p3,p4;
    Choice c1; //show popup menu of choices. Found in java.awt package
    Login(){
        super("Login Page");
        setLayout(null);
        ...
        ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("icon/login.png")); //makes icon from images. An implementation of Icon interface.
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                ...
                ResultSet rs = c.s.executeQuery(q); //table of data representing a database result set, generated by executing a statement that queries the database.
                                                    //executeQuery() is used to implement DQL in SQL
                if(rs.next()){
